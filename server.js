...
async function handleAPI(req, res, urlPath) {
  ...
  if (urlPath === '/api/dev-login' && req.method === 'POST') {
    try {
      ...
      res.setHeader('Set-Cookie', 'devAccess=1; HttpOnly; Max-Age=7200; Path=/; SameSite=Strict');
